...
const FAQ_ITEMS = [
  ...
  },
  {
    id: "grading",
    category: "등급",
    question: "NEW / S / A+ 등급은 어떤 기준으로 나뉘나요?",
    answer: [
      "수북은 신규 입고 교재를 모두 \"NEW(새 책)\" 등급으로 우선 매입하며, 기존 재고는 등급에 따라 함께 노출됩니다.",
      { type: "subheading", text: "NEW (새 책)" },
      "비닐 개봉 여부와 관계없이 필기·형광펜이 전혀 없고 표지·내지가 양호한 미사용 교재입니다. 2026년 5월부터 신규 입고는 모두 NEW 등급으로 매입합니다.",
      { type: "subheading", text: "S (거의 새 책) — 기존 재고" },
      ...
      { type: "note", text: "기존 S/A+/A 등급은 재고 소진까지만 운영되며, 신규 입고분은 모두 NEW 등급입니다. NEW 기준에 미달하는 교재는 판매 대상에서 제외됩니다." },
    ],
  },
  {
    id: "shipping-pickup",
