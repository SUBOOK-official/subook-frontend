...
const FAQ_ITEMS = [
  {
    ...
    answer: [
      ...
      "아울러 수북은 적법하게 유통된 실물 교재만을 취급하며, 무단 복제본·스캔본·PDF 등은 어떠한 경우에도 취급하지 않습니다.",
    ],
  },
  {
    id: "grading",
    ...
    answer: [
      "수북은 신규 입고 교재를 모두 \"S(새 책)\" 등급으로 매입합니다. 현재 등급은 S와 A+ 두 종류로 운영하며, 기존 A 등급 재고가 일부 함께 노출될 수 있습니다.",
      { type: "subheading", text: "S (새 책)" },
      "비닐 개봉 여부와 관계없이 필기·형광펜이 전혀 없고 표지·내지가 양호한 미사용 교재입니다. 2026년 5월부터 신규 입고는 모두 S 등급으로 매입합니다.",
      { type: "subheading", text: "A+ (사용감 적음) — 기존 재고" },
      "필기율 10% 미만의 교재로, 연필 필기 또는 이름만 적힌 수준에 해당합니다. 전반적인 상태는 새책에 가깝고, 학습에 전혀 지장이 없는 상태입니다.",
      { type: "note", text: "신규 입고는 S 기준에 미달하는 교재(필기·형광펜·표지 손상 등)는 판매 대상에서 제외됩니다. 기존 A+·A 등급 재고는 소진까지만 운영됩니다." },
    ],
  },
  {
    id: "shipping-pickup",
    ...
    answer: [
      ...
      "수거는 무료입니다. 다만 박스 1개당 상품화 비용 5,000원이 발생하며, 사전 결제가 아니라 교재 판매 후 정산 과정에서 차감됩니다.",
      "여러 박스로 나눠 보내면 박스 수 × 5,000원이 부과되니, 가능하면 가장 큰 박스 하나에 담아 보내 주세요.",
    ],
  },
  {
    id: "is-selling",
    ...
    answer: [
      ...
      "판매 정산내역은 마이페이지에서 진행 현황을 볼 수 있습니다. 교재가 판매되어 구매 확정이 완료되면, 매월 1일에 입력해 주신 계좌로 정산됩니다.",
    ],
  },
  {
    id: "listing-time",
  ...
  },
  {
    ...
    answer: [
      ...
      "구매 확정된 판매 대금은 수수료를 제외하고 매월 1일에 회원가입 시 등록한 계좌로 자동 정산됩니다.",
    ],
  },
  {
    id: "legal",
    ...
    answer: [
      "수북은 셀러로부터 안 쓴(미사용) 교재를 위탁받아 검수 후 재판매하는 구조로 운영되며, 관련 법령을 준수하는 범위 내에서 서비스를 제공하고 있습니다.",
